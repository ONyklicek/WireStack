---
order: 70
summary: Self-contained recipes built from the public API — copy one into a component and adapt it.
---
...
plugin hook instead — see [Core Plugins](../core/plugins/hooks.md#hook-system).
...
[Core Plugins → Query Pipes](../core/plugins/extending.md#query-pipes).
...
- [Core Plugins](../core/plugins/index.md) — app-wide rules via hooks and pipes
