---
order: 40
summary: Every refusal goes through Laravel's Gate — what a table, a form, an action and a page each ask it, and when.
---
...
|----------|----------------|
| [Core Actions](../core/actions/index.md) | Row, bulk, header actions and modal actions |
