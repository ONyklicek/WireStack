...
<span class="inline-flex items-center gap-2"><span class="w-4 h-4 rounded ring-1 ring-gray-200 dark:ring-gray-700 shrink-0" style="background-color: {{ $swatch }};"></span>@if($displayValue !== '')<span class="font-mono text-gray-700 dark:text-gray-300">{{ $displayValue }}</span>@endif</span>
