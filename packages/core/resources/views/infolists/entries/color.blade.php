@php
    /** @var \NyonCode\WireCore\Infolists\Components\ColorEntry $field */
    ...
    <div class="text-sm">
        @if($value !== '-' && $value !== '')
            <span
                ...
                @endif
            >
                <span class="w-5 h-5 rounded ring-1 ring-gray-200 dark:ring-gray-700" style="background-color: {{ $value }};"></span>
