...
/**
 * Default icon set with built-in HeroIcons (solid, 20x20 viewBox).
 */
final class DefaultIconSet implements IconSet
{
    ...
    private static array $icons = [
        ...
        'arrow-top-right-on-square' => '<path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z"/><path d="M5 5a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H5V7h3a1 1 0 000-2H5z"/>',
        ...
        'arrow-uturn-left' => '<path fill-rule="evenodd" d="M7.793 2.232a.75.75 0 01-.025 1.06L3.622 7.25h10.128a5.25 5.25 0 010 10.5H10.75a.75.75 0 010-1.5h2.999a3.75 3.75 0 000-7.5H3.622l4.146 3.957a.75.75 0 01-1.036 1.085l-5.5-5.25a.75.75 0 010-1.085l5.5-5.25a.75.75 0 011.06.025z" clip-rule="evenodd"/>',
    ];
