...
namespace NyonCode\WireModuleNotifications\Tests;

use Livewire\LivewireServiceProvider;
use NyonCode\WireCore\WireCoreServiceProvider;
use NyonCode\WireForms\WireFormsServiceProvider;
use NyonCode\WireModuleNotifications\WireModuleNotificationsServiceProvider;
...
abstract class TestCase extends BaseTestCase
{
    protected function getPackageProviders($app): array
    {
        return [
            ...
            WireModuleNotificationsServiceProvider::class,
        ];
    }
