@php /** @var \NyonCode\WireForms\Components\TextInput $field */
...
@include('wire-forms::partials.field-wrapper-start')
    ...
    <input
        ...
        @if($field->getStep()) step="{{ $field->getStep() }}" @endif
        ...
        @if($field->getDatalistOptions()) list="{{ $field->getId() }}-datalist" @endif
